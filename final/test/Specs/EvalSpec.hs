...
evalSpecs = packSpecs [
        ...
        ("Expr-test-bool7", "(begin (set! tmp 1) (set! rst (not tmp)))",
            [("rst", Undefined)]),
        ("Expr-test-bool8", "(set! rst (and 'g' True))",
            [("rst", Undefined)]),
        ("Expr-test-bool9", "(set! rst (and True 'g'))",
            [("rst", Undefined)]),
        ("Expr-test-bool10", "(set! rst (or 'g' True))",
            [("rst", Undefined)]),
        ("Expr-test-bool11", "(set! rst (or True 'g'))",
            [("rst", Undefined)]),
        ("Expr-test-bool12", "(set! rst (not 2))",
            [("rst", Undefined)]),
        ...
        ("Expr-test-double7", "(set! rst (* 1 'A')",
            [("rst", Undefined)]),
        ("Expr-test-double8", "(set! rst (+ 'a' 1)",
            [("rst", Undefined)]),
        ("Expr-test-double9", "(set! rst (+ 1 'a')",
            [("rst", Undefined)]),
        ("Expr-test-double10", "(set! rst (- 'a' 1)",
            [("rst", Undefined)]),
        ("Expr-test-double11", "(set! rst (- 1 'a')",
            [("rst", Undefined)]),
        ("Expr-test-double12", "(set! rst (* 'a' 1)",
            [("rst", Undefined)]),
        ("Expr-test-double13", "(set! rst (* 1 'a')",
            [("rst", Undefined)]),
        ("Expr-test-double14", "(set! rst (/ 'a' 1)",
            [("rst", Undefined)]),
        ("Expr-test-double15", "(set! rst (/ 1 'a')",
            [("rst", Undefined)]),
        ...
        ("Expr-test-cmp10", "(set! rst (> 1 True))",
            [("rst", Undefined)]),
        ("Expr-test-cmp11", "(set! rst (> True 2))",
            [("rst", Undefined)]),
        ("Expr-test-cmp12", "(set! rst (< 1 True))",
            [("rst", Undefined)]),
        ("Expr-test-cmp13", "(set! rst (< True 2))",
            [("rst", Undefined)]),
        ("Expr-test-cmp14", "(set! rst (>= 1 True))",
            [("rst", Undefined)]),
        ("Expr-test-cmp15", "(set! rst (>= True 3))",
            [("rst", Undefined)]),
        ("Expr-test-cmp16", "(set! rst (<= 1 True))",
            [("rst", Undefined)]),
        ("Expr-test-cmp17", "(set! rst (<= True 4))",
            [("rst", Undefined)]),
        ("Expr-test-cmp18", "(set! rst (= 1 True))",
            [("rst", Undefined)]),
        ("Expr-test-cmp19", "(set! rst (= True 4))",
            [("rst", Undefined)]),
        ...
        ("Stmt-test-if5", "(if (> 1 2) (set! x 1) skip))",
            [("x", Undefined), ("y", Undefined)]),
        ("Stmt-test-if6", "(if (> 1 'p') (set! x 1) skip))",
            [("x", Undefined), ("y", Undefined)]),
        ...
        ("Expr-test-show2", "'a'", []),
        ("Expr-test-show3", "+", []),
        ("Expr-test-show4", "1 2 3", []),
        ("Expr-test-show5", "main", []),
        ("Expr-test-show6", "(+ 1 2)", []),
        ("Expr-test-show7", "Er", []),
        ("Expr-test-show8", "c", [])
    ] where
